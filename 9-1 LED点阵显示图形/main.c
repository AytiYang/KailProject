...
void main()
{
	...
	while(1)
	{
		...
		MatrixLED_ShowColumn(1,0xFE);
		MatrixLED_ShowColumn(2,0xFC);
		MatrixLED_ShowColumn(3,0xF8);
		MatrixLED_ShowColumn(4,0xF0);
		MatrixLED_ShowColumn(5,0xE0);
		MatrixLED_ShowColumn(6,0xC0);
		MatrixLED_ShowColumn(7,0x80);
	}
}